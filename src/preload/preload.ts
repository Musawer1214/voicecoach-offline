...
const api: VoiceCoachApi = {
  ...
  revealDataFolder: () => ipcRenderer.invoke("data:reveal-folder") as Promise<string>,
  getTrustSnapshot: () => ipcRenderer.invoke("data:trust-snapshot") as Promise<TrustSnapshot>,
  createDataBackup: () => ipcRenderer.invoke("data:create-backup") as Promise<DataBackupResult>,
